...
<body class="logged_out marketing windows env-production ">
  ...
  <div id="page-settings" class="context-loader-container" data-pjax-container="">
    ...
    <c:set var="selected">phrases</c:set>
    ...
    <div class="settings-content">
      ...
      <div class="boxed-group js-ssh-keys-box">
        ...
        <a href="javascript:;" id="add_key_action" class="js-show-new-ssh-key-form minibutton lighter bigger boxed-group-action" onclick="$('#newRule').toggleNice()">Add Phrase</a>
        <h3>Phrases</h3>
        ...
        <div id="newRule" class="boxed-group js-new-ssh-key-box" style="display:none;">
          ...
          <dl class="form">
            <dt><label>Phrase</label><img src="/images/help.png" align="bottom" class="help" alt="A phrase is automatically quoted by the engine and no spell correction or thesaurus is applied" style="opacity: 0.2;" aria-describedby="ui-tooltip-8"></dt>
