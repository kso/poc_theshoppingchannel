...
<fmt:formatNumber pattern="0.00">${refinement.low}</fmt:formatNumber> ${empty refinement.high ? '+' : ' - '}${empty refinement.high ? '+' : prefix}<fmt:formatNumber pattern="0.00">${refinement.high}</fmt:formatNumber>
</label>
</li>